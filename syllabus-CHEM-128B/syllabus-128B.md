...
3. **Preparation, practice, and participation (PPP)** category includes poins earned on online  pre-class assignments and online homework (WileyPLUS) as well as participation during lecture (iClicker). It is in your interest to complete pre-class assignments because the results guide my decisions about what activities to plan and what concepts to focus on in the upcoming class meeting. You will also have the opportunity to earn points for participation in clicker questions. Research shows that classroom response systems (clickers) help students learn more and do better in the course. I have successfully used the student response system to gauge student learning and direct the flow of the lecture. You will earn one point for participation in polling sessions and one point for each correctly answered question.
