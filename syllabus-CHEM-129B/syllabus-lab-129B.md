...
CHEM 129B is the second part of the 2-semester sequence in organic chemistry laboratory. As such it is primarily concerned with introducing intermediate level concepts and techniques used in organic chemistry. We will continue to use the techniques covered in the first semester lab and will introduce additional methods and techniques such as NMR spectroscopy, multi-step synthesis, green chemistry, and chemical literature. 
...
* Describe what they see (macroscopic) with chemical language (microscopic & sub-microscopic).
* Design ways to separate a mixture into its components by manipulating physical and chemical properties.
...
- **Techniques Reference Manual** [LibreTexts e-book by Lisa Nichols](https://chem.libretexts.org/Bookshelves/Organic_Chemistry/Book:_Organic_Chemistry_Lab_Techniques_(Nichols)) is our recommended reference for laboratory techniques. The textbook by Pavia et al. is listed as the official textbook for this course, but we are in the process of phasing it out. If you own a copy of Pavia's textbook (5th or 6th edition), then feel free to use it in addition to the LibreTexts option
...
- Grade "R" will receive partial score (2%) with an option to revise based on the feedback and then resubmit.
- Grade "N" will receive partial score (1%) with an option to revise and resubmit but there will be minimal to no feedback. 
...
| L# | Week of | Lab Day | Lab Activities                                                      |  
| -- | ------- | ------- | ------------------------------------------------------------------- |  
| 1  | 21-Aug  | Mon     | Lab orientation, syllabus, chemical safety. Locker check-in.        |  
| 2  |         | Wed     | Separation of a mixture of solids: SOP development                  |  
| 3  | 28-Aug  | Mon     | Separation of a mixture of solids: separation & purification        |  
| 4  |         | Wed     | Separation of a mixture of solids: data analysis                    |  
| X  | 4-Sep   | Mon     | NO LAB (Labor Day)                                                  |  
| 5  |         | Wed     | Solvent-less synthesis of chalcones: grinding, isolation            |  
| 6  | 11-Sep  | Mon     | Solvent-less synthesis of chalcones: recrystallization, mp, IR, NMR |  
| 7  |         | Wed     | Solvent-less synthesis of chalcones: data analysis                  |  
| 8  | 18-Sep  | Mon     | Literature Research Tools (with Mystery New Person @Library)        |  
| 9  |         | Wed     | Synthesis experiment   stoichiometry. Preparation of hydrobenzoin.  |  
| 10 | 25-Sep  | Mon     | Acetonide of hydrobenzoin: reaction & work-up                       |  
| 11 |         | Wed     | Acetonide of hydrobenzoin: NMR data analysis                        |  
| 12 | 2-Oct   | Mon     | Reduction with CIP in water: synthesis and monitoring with TLC      |  
| 13 |         | Wed     | Reduction with CIP in water: work-up, isolation, NMR sample prep    |  
| 14 | 9-Oct   | Mon     | Reaction efficiency   metrics: qNMR assay of reaction yield         |  
| 15 |         | Wed     | Buffer zone                                                         |  
| 16 | 16-Oct  | Mon     | Unknown arene: Friedel–Crafts acylation                             |  
| 17 |         | Wed     | Unknown arene: isolation, purification, and NMR                     |  
| 18 | 23-Oct  | Mon     | Unknown arene: NMR analysis                                         |  
| 19 |         | Wed     | Research Projects                                                   |  
| 20 | 30-Oct  | Mon     | Research Projects                                                   |  
| 21 |         | Wed     | Research Projects                                                   |  
| 22 | 6-Nov   | Mon     | Research Projects                                                   |  
| 23 |         | Wed     | Research Projects                                                   |  
| 24 | 13-Nov  | Mon     | Research Projects                                                   |  
| 25 |         | Wed     | Research Projects                                                   |  
| 26 | 20-Nov  | Mon     | Catch-up, wrap-up, etc.                                             |  
| 27 |         | Wed     | NO LAB (Thanksgiving Break)                                         |  
| 28 | 27-Nov  | Mon     | Presentations                                                       |  
| 29 |         | Wed     | Presentations                                                       |  
| 30 | 4-Dec   | Mon     | Locker check-out                                                    |  
|    |         | Wed     | NO LAB                                                              |  